...
const floatingCards = [
  ...
  {
    name: "Clay Courts",
    imageSrc: "https://storage.googleapis.com/webild/users/user_3AniccObAoDJgCkSlT6RJk7a8NL/uploaded-1782956113612-ffy5j83t.jpg"
  }
];
...
const CARD_CONFIG = [
  ...
  { position: "left", bottom: "5%", aspect: "aspect-square", movement: "-50%" },
] as const;
...
const HeroInline = () => {
  ...
  const thirdCardY = useTransform(scrollYProgress, [0, 1], ["0%", CARD_CONFIG[2].movement]);
  const cardYTransforms = [leftCardY, rightCardY, thirdCardY];
